...
incursionNotice(this_trigger := "") {
	...
	if ((ui.latestIncursion != cfg.lastIncursion) && cfg.pushNotificationsEnabled) || (ui.incursionDebug == true) || (this_trigger == "manualFire") {
		...
		ui.incursionGuiBg2 := ui.incursionGui.addText("x5 y5 w340 h40 background" cfg.TrimColor3)
		drawOutlineNamed("notice",ui.incursionGui,1,1,348,48,cfg.TrimColor2,cfg.AuxColor3,2)			
		drawPanelLabel(ui.incursionGui,224,0,100,20,"Destiny2 Event",cfg.FontColor3,cfg.AuxColor3,cfg.TrimColor3)
		...
		drawOutlineNamed("incursionClose",ui.incursionGui,329,-2,21,22,cfg.AuxColor3,cfg.AuxColor3,1)
