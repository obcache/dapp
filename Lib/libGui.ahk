...
drawTabs(this_gui:=ui.mainTabGui,tabControl:=ui.mainGuiTabs,tabX:=0,tabY:=0,tabNames:=["Game","Setup"],tabWidths:=[83,82],orient:="top") {
	...
	ui.%this_gui.name%Tab1InactiveRight:=this_gui.addPicture("hidden x" tabX+1+tabWidths[1]-(cfg.curveAmount/3) " y" 2 " w" cfg.curveAmount/3 " h" 24 " backgroundTrans","./img/custom/lightburst_right_bar_dark.png")
