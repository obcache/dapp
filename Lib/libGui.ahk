...
tabsChanged(*) {
	...
	(ui.activeTab=="1_Game____")
		? (	 ui.1_GameButtonBg:=ui.mainGui.addText("x34 y0 w83 h28 background" cfg.TrimColor1)
			...
			, ui.1_GameButtonDetail:=ui.mainGui.addPicture("x34 y0 w83 h" cfg.curveAmount " backgroundTrans","./img/custom/lightburst_top_bar_light.png")
			, ui.1_GameButtonDetail2:=ui.mainGui.addPicture("hidden x36 y" 26-cfg.curveAmount " w81 h" cfg.curveAmount " backgroundTrans","./img/custom/lightburst_bottom_bar_dark.png")
			, ui.2_SetupButtonDetail:=ui.mainGui.addPicture("x117 y0 w80 h" cfg.curveAmount " backgroundTrans","./img/custom/lightburst_top_bar_light.png")			
			, ui.2_SetupButtonDetail2:=ui.mainGui.addPicture("x117 y" 28-cfg.curveAmount " w80 h" cfg.curveAmount " backgroundTrans","./img/custom/lightburst_bottom_bar_dark.png")	
		...
		: (ui.tabDivider:=ui.mainGui.addText("hidden x117 y02 w2 h28 background" cfg.TrimColor1)
			...
			, ui.1_GameButtonDetail:=ui.mainGui.addPicture("hidden x34 y0 w81 h" cfg.curveAmount " backgroundTrans","./img/custom/lightburst_top_bar_light.png")
			, ui.1_GameButtonDetail2:=ui.mainGui.addPicture("x34 y" 28-cfg.curveAmount " w81 h" cfg.curveAmount " backgroundTrans","./img/custom/lightburst_bottom_bar_dark.png")
			, ui.2_SetupButtonDetail:=ui.mainGui.addPicture("x115 y0 w82 h28 backgroundTrans","./img/custom/lightburst_top_bar_light.png")			
...
advProgress(2)
	...
	ui.3_FillDetail1:=ui.mainGui.addPicture("x196 y0 w340 h" cfg.curveAmount " backgroundTrans","./img/custom/lightburst_top_bar_light.png")
