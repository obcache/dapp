...
cfgLoad(&cfg, &ui) {
	...
	cfg.dappAutoSprintKey			:= iniRead(cfg.file,"Game","dappAutoSprintKey","Pause")
	cfg.dappEnabledKey			:= iniRead(cfg.file,"Game","dappEnabledKey",false)
	...
	cfg.dappAutoSprintKey	:= IniRead(cfg.file,"Game","dappAutoSprintKey","capslock")
	...
	cfg.d2GameAutoSprintKey	:= IniRead(cfg.file,"Game","d2GameAutoSprintKey","capslock")
...
WriteConfig() {
	...
	iniWrite(cfg.dappAutoSprintKey,cfg.file,"Game","dappAutoSprintKey")
	iniWrite(cfg.dappEnabledKey,cfg.file,"Game","dappEnabledKey")
	...
	IniWrite(cfg.d2GameAutoSprintKey,cfg.file,"Game","d2GameAutoSprintKey")
