...
ui.gametabs.useTab("222Vault Cleaner222")
	...
	this.statBg:=ui.gameSettingsGui.addPicture("x11 y80 w275 h62 background" cfg.themeDark2Color,"./img/lightburst_tr_light.png")
	;this.statBg2:=ui.gameSettingsGui.addPicture("x245 y80 w275 h62 background" cfg.themeDark2Color,"./img/lightburst_bottom_light.png")
	ui.gameSettingsGui.addText("x245 y80 w242 h62 background" cfg.themeDark2Color)
	ui.gameSettingsGui.addPicture("x245 y80 w242 h62 background" cfg.themeDark2Color,"./img/lightburst_tl.png")
	drawOutlineNamed("vaultStats2",ui.gameSettingsGui,245,78,244,66,cfg.themeBright2Color,cfg.themeBorderDarkColor,2)
	this.pageLabel:=ui.gameSettingsGui.addText("right x370 y80 w80 h25 backgroundTrans c" cfg.themeFont1Color "","Page: ")
	this.pageCount:=ui.gameSettingsGui.addText("x420 y81 right w56 h25 c" cfg.themeFont1Color " backgroundTrans",format("{:03d}",this.page))
	this.statusHeaderLabel:=ui.gameSettingsGui.addText("x420 y81 w140 left h25 c" cfg.themeFont1Color " backgroundTrans","")
	this.elapsed:=ui.gameSettingsGui.addText("x340 y100 w80 right h25 c" cfg.themeFont1Color " backgroundTrans","Elapsed: ")
	this.elapsedTime:=ui.gameSettingsGui.addText("x420 y100 left w80 h25 c" cfg.themeFont1Color " backgroundTrans","00:00:00")
	this.remaining:=ui.gameSettingsGui.addText("x340 y120 right w80 h25 c" cfg.themeFont1Color " backgroundTrans","Remaining: ")
	this.remainingtime:=ui.gameSettingsGui.addText("x420 y120 left w80 h25 c" cfg.themeFont1Color " backgroundTrans","00:00:00")
	this.dismantledHeaderLabel:=ui.gameSettingsGui.addText("x250 y0 w110 right h25 c" cfg.themeFont1Color " backgroundTrans","")
	this.dismantledLegendaryLabel:=ui.gameSettingsGui.addText("section x255 y82  left h25 c" cfg.themeFont1Color " backgroundTrans","Legendary: ")
	this.dismantledLegendary:=ui.gameSettingsGui.addText("x+0 ys+1 left w83 h25 c" cfg.themeFont1Color " backgroundTrans",format("{:03d}","000"))
	this.dismantledExoticLabel:=ui.gameSettingsGui.addText("section x255 y100 left h25 c" cfg.themeFont1Color " backgroundTrans","Exotic: ")
	this.dismantledExotics:=ui.gameSettingsGui.addText("x+0 ys+0 left w80 h25 c" cfg.themeFont1Color " backgroundTrans",format("{:03d}","000"))
	this.dismantledTotalLabel:=ui.gameSettingsGui.addText("section x255 y118 left h25 c" cfg.themeFont1Color " backgroundTrans","Total: ")
	this.dismantledTotal:=ui.gameSettingsGui.addText("x+0 ys+0 left w80 h25 c" cfg.themeFont1Color " backgroundTrans",format("{:03d}","000"))
