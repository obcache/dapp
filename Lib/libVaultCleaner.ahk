...
ui.gametabs.useTab("222Vault Cleaner222")
	...
	this.mainButtonHotkey:=ui.gameSettingsGui.addPicture("hidden left x36 y10 background" cfg.trimColor1 " c" cfg.fontColor1 " h17 w67","./img/lightburst_bottom_light.png")
	this.mainButtonHotkeyText:=ui.gameSettingsGui.addText("left x91 y12 backgroundTrans c" cfg.fontColor2 " h19 w280","Press [Del] to START")
