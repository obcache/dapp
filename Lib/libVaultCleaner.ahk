...
ui.gametabs.useTab("Vault Cleaner")
	...
	ui.gameSettingsGui.addPicture("x10 y30 w476 h22 backgroundTrans","./img/lightburst_top_light.png")
	;ui.gameSettingsGui.addPicture("x10 y30 w476 h22 backgroundTrans","./img/lightburst_top_light.png")
	...
	this.mainButton:=ui.gameSettingsGui.addPicture("section center x10 y10 w75 h20 background" cfg.bgColor1 " c" cfg.fontColor3,"./img/lightburst_tl_light.png")
	;this.mainButtonTextBg:=ui.gameSettingsGui.addPicture("x85 y10 w200 h20 backgroundTrans","./img/lightburst_bl_light.png")
	this.mainButtonTextBg1:=ui.gameSettingsGui.addPicture("x85 y10 w403 h20 backgroundTrans","./img/lightburst_tr_light.png")
	this.mainButtonTextBg2:=ui.gameSettingsGui.addPicture("x85 y10 w403 h20 backgroundTrans","./img/lightburst_br_light.png")
	this.mainButtonTextBg3:=ui.gameSettingsGui.addPicture("x85 y10 w403 h20 backgroundTrans","./img/lightburst_tl_light.png")
	this.mainButtonTextBg4:=ui.gameSettingsGui.addPicture("x85 y10 w403 h20 backgroundTrans","./img/lightburst_bl_light.png")
	;this.mainButtonBg:=ui.gameSettingsGui.addPicture("x10 y10 w85 h20 backgroundTrans","./img/lightburst_br_light.png")
	...
	this.mainButtonHotkey:=ui.gameSettingsGui.addPicture("hidden left x36 y10 background" cfg.trimColor1 " c" cfg.fontColor4 " h20 w70")
	this.mainButtonHotkeyDetail1:=ui.gameSettingsGui.addPicture("left x10 y10 backgroundTrans h20 w243","./img/lightburst_bl_light.png")
	this.mainButtonHotkeyDetail2:=ui.gameSettingsGui.addPicture("left x10 y10 backgroundTrans h20 w243","./img/lightburst_tl_light.png")
	this.mainButtonHotkeyDetail1:=ui.gameSettingsGui.addPicture("left x245 y10 backgroundTrans h20 w243","./img/lightburst_br_light.png")
	this.mainButtonHotkeyDetail2:=ui.gameSettingsGui.addPicture("left x245 y10 backgroundTrans h20 w243","./img/lightburst_tr_light.png")
	...
	this.statusTextDetail3:=ui.gameSettingsGui.addPicture("x10 y30 w468 h22 backgroundTrans","./img/lightburst_tl_light.png")
	this.statusTextDetail4:=ui.gameSettingsGui.addPicture("x10 y30 w468 h22 backgroundTrans","./img/lightburst_bl_light.png")
