...
ui.gametabs.useTab("Vault Cleaner")
	...
	this.mainButton:=ui.gameSettingsGui.addPicture("section center x10 y10 w75 h20 background" cfg.bgColor1 " c" cfg.fontColor3,"./img/custom/lightburst_tl_light.png")
	;this.mainButtonTextBg:=ui.gameSettingsGui.addPicture("x85 y10 w200 h20 backgroundTrans","./img/custom/lightburst_bl_light.png")
	this.mainButtonTextBg1:=ui.gameSettingsGui.addPicture("x85 y10 w403 h20 backgroundTrans","./img/custom/lightburst_tr_light.png")
	...
	this.mainButtonHotkeyDetail1:=ui.gameSettingsGui.addPicture("left x10 y10 backgroundTrans h20 w243","./img/custom/lightburst_bl_light.png")
	...
	this.mainButtonHotkeyDetail1:=ui.gameSettingsGui.addPicture("left x245 y10 backgroundTrans h20 w243","./img/custom/lightburst_br_light.png")
	...
	ui.gameSettingsGui.addPicture("x246 y81 w240 h60 background" cfg.trimColor1,"./img/custom/lightburst_tl.png")
	...
	this.vaultDetail2:=ui.gameSettingsGui.addPicture("x200 y52 w288 h20 backgroundTrans","./img/custom/lightburst_br_light.png")
